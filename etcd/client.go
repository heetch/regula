/*
Package etcd contains types providing fetching and watching capabilities by directly reading from the etcd store.
It is designed to be directly pluggable with the engine.
This package is temporary and will be replaced by a full HTTP implementation.
*/
package etcd
